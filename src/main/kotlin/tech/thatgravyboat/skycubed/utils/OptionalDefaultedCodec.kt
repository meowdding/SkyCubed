...
data class OptionalDefaultedCodec<Type : Any>(val field: String, val codec: Codec<Type>, val isLenient: Boolean = false, val constructor: () -> Type) :
    MapCodec<Optional<Type>>() {
