...
public abstract class AbstractContainerScreenMixin implements AbstractContainerScreenAccessor {
    ...
    //? if > 1.21.11 {
    @Shadow protected abstract void extractSlot(net.minecraft.client.gui.GuiGraphicsExtractor par1, Slot par2, int par3, int par4);
    @Override
    ...
    *///?} else {
    ...
    /*@Shadow public abstract void renderSlot(net.minecraft.client.gui.GuiGraphics guiGraphics, Slot slot);
    @Override
    public void skycubed$renderSlot(net.minecraft.client.gui.GuiGraphics guiGraphics, Slot slot, int mouseX, int mouseY) {
