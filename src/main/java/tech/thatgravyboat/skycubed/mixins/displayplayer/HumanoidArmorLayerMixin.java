...
public class HumanoidArmorLayerMixin {
    ...
    private void onRender(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, HumanoidRenderState renderState, float yRot, float xRot, Operation<Void> original) {
